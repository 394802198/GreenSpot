...
<div class="container-100-percent bg-success">
    <div class="container text-success">
        <br/><br/><br/><br/><br/>
        <h1>Unfortunately, your payment isn't successful!!!</h1>
        <br/>
        <h2>We didn't received your payment for GreenSpot Services, please check your card detail and try again!</h2>
        <br/>
